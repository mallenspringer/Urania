...
export const DIAGNOSTIC_3LAYER_TEMPLATE: Template = {
  manifest: {
    ...
    description: "A 3-dial test template for verifying multi-layer masking, star windows, circle windows, and text cutout windows interacting simultaneously across red, green, and blue rings.",
    version: 1,
    mechanismType: "volvelle",
    author: "Urania System",
    createdDate: now,
  ...
  project: {
    ...
    metadata: {
      name: "3-Layer Diagnostic Test",
      author: "Urania System",
      description: "A 3-dial diagnostic volvelle with red base, green middle ring with 4 star windows, and blue top ring with circle and text windows.",
      createdAt: now,
      updatedAt: now,
    },
    settings: {
